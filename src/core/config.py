...
class Settings(BaseSettings):
    ...
    # Study Profiles database (normalized schema with lookup tables for filtering).
    # Same server as postgres_host by default — only the database name differs.
    study_profiles_database: str = "study-profiles"
